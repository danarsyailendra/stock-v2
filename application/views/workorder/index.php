        ...
        <div class="row">
            <div class="col-md-12 col-xs-12">
                ...
                <?php if (in_array('createWorkorder', $user_permission)): ?>
                    <a href="<?php echo base_url('workorder/create') ?>" class="btn btn-primary">Add Work Orders</a>
                    <br /> <br />
                <?php endif; ?>
...
<?php if (in_array('approveWorkorder', $user_permission)): ?>
    <!-- remove brand modal -->
    <div class="modal fade" tabindex="-1" role="dialog" id="approveModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">Approve Workorder</h4>
                </div>

                <form role="form" action="<?php echo base_url('workorder/approve') ?>" method="post" id="approveForm">
                    <div class="modal-body">
                        <p>Approve Workorder?</p>
                    </div>
                    <div class="modal-footer">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        manageTable = $('#manageTable').DataTable({
            'ajax': base_url + 'workorder/fetchWorkorderData',
            'order': [],
            'columnDefs':[
                {
                    "targets":[8],

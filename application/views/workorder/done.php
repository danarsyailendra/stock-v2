            ...
            <div class="col-md-12 col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Done Work Order</h3>
                    </div>
                    <!-- /.box-header -->
                    <form role="form" action="<?php echo base_url('workorder/done/' . $workorder_data['id']) ?>" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="input_date" name="input_date" placeholder="Enter Input Date" value="<?php echo $workorder_data['input_date']; ?>" autocomplete="off" />
                            </div>

                            <div class="form-group">
                                <label for="deadline">Deadline</label>
                                <input type="text" class="form-control" id="deadline" name="deadline" placeholder="Enter Deadline" value="<?php echo $workorder_data['deadline']; ?>" autocomplete="off" />
                            </div>
                            ...
                            <div class="form-group">
                                <label for="workorder_image">Evidence</label>
                                <div class="kv-avatar">
                                    <input id="workorder_evidence" name="workorder_evidence" required="" type="file">
                                </div>
                            </div>
                        </div>
                        <!-- /.box-body -->

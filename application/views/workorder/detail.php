            ...
            <div class="col-md-12 col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Detail Work Order</h3>
                    </div>
                    <!-- /.box-header -->
                    <form role="form" action="" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="workorder_evidence">evidence</label>
                                <div class="kv-avatar">
                                    <a target="_blank" href="<?= base_url() . $workorder_data['evidence']?>"><?=$workorder_data['evidence_file']?></a>
                                </div>
                            </div>
                        </div>
                        <!-- /.box-body -->

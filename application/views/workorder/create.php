          ...
          <form role="form" action="<?php base_url('users/create') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control datepicker" id="input_date" name="input_date" placeholder="Enter Tanggal Input" autocomplete="off" />
                </div>

                <div class="form-group">
                  <label for="deadline">Deadline</label>
                  <input type="text" class="form-control datepicker" id="deadline" name="deadline" placeholder="Enter Deadline" autocomplete="off" />
                </div>
                  
                <div class="form-group">
                  <label for="backend">Backend</label>
                  <input type="number" class="form-control" id="backend" name="backend" placeholder="Enter Backend" autocomplete="off" />
                </div>
                <div class="form-group">
                  <label for="frontend">Frontend</label>
                  <input type="number" class="form-control" id="frontend" name="frontend" placeholder="Enter Frontend" autocomplete="off" />
                </div>
                <div class="form-group">
                  <label for="qa">QA</label>
                  <input type="number" class="form-control" id="qa" name="qa" placeholder="Enter QA" autocomplete="off" />
                </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#addWorkorderNav").addClass('active');

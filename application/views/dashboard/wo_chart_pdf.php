<html>
    <head>
        ...
        <!-- PrintJS -->
        <script src="<?php echo base_url('assets/bower_components/print.js/print.min.css') ?>"></script>
        ...
        <!-- PrintJS -->
        <script src="<?php echo base_url('assets/bower_components/print.js/print.min.js') ?>"></script>

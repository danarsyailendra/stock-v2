...
class Users extends Admin_Controller {
    ...
    public function create() {
        ...
        $this->form_validation->set_rules('nik', 'NIK', 'trim|required|min_length[5]');
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $cek_user = $this->model_users->cekUser($this->input->post('nik'));
            if ($cek_user['jumlah'] > 0) {
                echo "<script>alert('NIK Already Exist!')</script>";
                $this->session->set_flashdata('errors', 'NIK Already Exist!');

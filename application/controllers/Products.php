    ...
    */
	public function fetchProductData()
	{
		...
		foreach ($data as $key => $value) {
            ...
            $store_data = $this->model_brands->getBrandData($value['id']);
            $store_data2 = $this->model_category->getCategoryData($value['id']);
			// button
            $buttons = '';
			...
			$img = '<img src="'.base_url($value['lampiran']).'" alt="'.$value['name'].'" class="img-circle" width="50" height="50" />';
	...
	public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {
        	...
        	$data = array(
        		...
        		'channel_name' => json_encode($this->input->post('channel_name')),
        		'produk_name' => json_encode($this->input->post('produk_name')),
                'marketing_name' => $this->input->post('marketing_name'),
                'bobot' => $this->input->post('bobot'),
                'input_date' => $this->input->post('input_date'),
                'deadline' => $this->input->post('deadline'),
        		'catatan' => $this->input->post('catatan'),
                'lampiran' => $upload_image,
        	);
